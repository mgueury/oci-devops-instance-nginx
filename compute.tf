...
terraform {
  backend "http" {
    address = "https://objectstorage.eu-frankfurt-1.oraclecloud.com/p/ImwyAv5IhF9JeW_kJHZJK7yCYDpL0bGbky3PQ4ektR1rPE8k7mDorDpVDFFLfa55/n/frsxwtjslf35/b/shared-bucket/o/terraform_devopsinstance1.tfstate"
    update_method = "PUT"
  }
}
